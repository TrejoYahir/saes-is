...
public class RegistrarAlumno extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            if(regcorreo&!regnum)
                       out.println("<script>alert('El número de boleta ya fue asignado a otro usuario');location='registrarAlumno.jsp';</script>");
            if(!regcorreo&regnum)
                       out.println("<script>alert('El correo está registrado en otra cuenta');location='registrarAlumno.jsp';</script>");
            if(!regcorreo&!regnum)
                       out.println("<script>alert('El correo está registrado en otra cuenta');alert('El número de boleta ya fue asignado a otro usuario');location='registrarAlumno.jsp';</script>");
    }
