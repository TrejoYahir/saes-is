...
public class EditarGrupo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException{
        ...
        if(noexiste) {
            out.println("<script>alert('Se actualizaron los datos correctamente.');location='editarGrupo.jsp?id="+id+"';</script>");
        }
        if(!noexiste) {
            out.println("<script>alert('El grupo ya existe');location='editarGrupo.jsp?id="+id+"';</script>");
        }
    }
