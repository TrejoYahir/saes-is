           ...
           request.setCharacterEncoding("UTF-8");
            ...
            try {
                ...
                if(validado(materia,profesor,grupo,horario,out)){
                    ps=con.prepareStatement("update clase set Grupo_idGrupo=?,Materias_idmaterias=?,profesor_rfc=?,tipo_horario_idtipo_horario=? where idclase=?");
                    ...
                    ps.setInt(5, idclase);
                    ps.executeUpdate();
                    out.println("<script>alert('Se actualizaron los datos correctamente.'); location='editarHorario.jsp?idClase="+idclase+"';</script>");
                }else{
                    out.println("<script>location='editarHorario.jsp?idClase="+idclase+"';</script>");
                }
