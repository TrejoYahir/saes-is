...
function validarDisponibilidad(){
    ...
    for (var i = 0; i < len-1; i++) {
        ...
        if(cupo=="0"){
            alert("Lo sentimos, ya no hay cupo");
            return false;
        }
    }
    return true;
...
function validarCreditos(){
    ...
    if(sumacreditos<=19 || sumacreditos>=45){
        alert("No se encuentra en el rango de créditos");
        return false;
    }else{
        return true;
    }
...
function validarHorario(){
    ...
    for (var i = 0; i < lenfilas-1; i++) {
        ...
        if(repiteHorario(horarios,creditos)){
            alert("Se genera un traslape de materias, por favor escoge la materia en otro horario");
            return false;
        }else{
