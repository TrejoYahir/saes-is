...
function confirmarBaja(idAlumno,idclase){
    if(confirm("¿Seguro que quiere dar de baja la materia?")){
        location="BorrarClaseAlG?idalumno="+idAlumno+"&idclase="+idclase;
    }
}

function mostrarInscripcion(){
    var oculto=$("#destinoBusqueda");
    $(oculto).toggleClass("oculto");
    var anuncio=$(".anuncio");
    $(anuncio).toggleClass("oculto");
}
