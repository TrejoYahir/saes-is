    ...
    <body>
        <%
            ...
            if (request.getParameter("keyword") != null) {
                ...
                select = " WHERE RFC LIKE '%" + keyword + "%' and gestion.usuario_idusuario=usuario.idusuario";
            }else{
                select = " WHERE gestion.usuario_idusuario=usuario.idusuario";
            }
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main col">
                    <div class="p-3">
                        <h3 class="pb-3">Administrar analista</h3>
                        <form action="administrarAnalista.jsp" method="get">
                        ...
                        <%
                            ...
                            try {
                                String sql = "SELECT * FROM gestion,usuario" + select;
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><%=apellidom%></td>
                                <td><%=correo%></td>
                                <th class="text-center"><a class="btn btn-primary" href="./editarAnalista.jsp?id=<%=id%>">Editar</a></th>
                            </tr>
                            <%
                                }
                            %>                                        
