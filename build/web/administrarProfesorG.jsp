    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main col">
                    <div class="p-3">
                        <h3 class="pb-3">Administrar profesor</h3>
                        <form action="administrarProfesorG.jsp" method="get">
                        ...
                        <%
                            ...
                            try {
                                String sql = "SELECT * FROM profesor" + select;
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><%=apellidom%></td>
                                <td><%=correo%></td>
                                <th class="text-center"><a class="btn btn-primary" href="./editarProfesorG.jsp?id=<%=id%>">Editar</a></th>
                            </tr>
                            <%
                                }
                            %>                                        
