		...
		<div class="row">
			...
			<main class="main col">
				<div class="row align-items-center justify-content-center main">
					<div class="col-5">
						<h2 class="text-center mb-3 mt-5">Registrar alumno</h2>
						<form action="RegistrarAlumnoG" method="POST">
							...
							<div class="form-group">
								<label for="nombre">Boleta</label>
								<input type="text" pattern="^[0-9]{10}$" name="boleta" required class="form-control" />
