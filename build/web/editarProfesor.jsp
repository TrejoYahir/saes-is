        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main col align-items-center justify-content-center main">
                    ...
                    %>
                    <div class="p-3">
                        <h3 class="pb-3">Editar profesor</h3>
                    ...
                    <form class="p-3" style="max-width: 400px;" action="EditarProfesor" method="post">
                        ...
                        <a href="administrarProfesor.jsp"><button type="button" class="btn btn-primary">Regresar</button></a>
                    </form>
                    <%
                        }else{
                     %>
