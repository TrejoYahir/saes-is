		...
		<div class="row">
			...
			<main class="main col">
				<div class="row align-items-center  ">
						<div class="col-12">
							<h1 class="display-5 mt-3" align="center">Asignar horario</h1> <br><br>
						</div>
					</div>
					<div class="row align-items-center justify-content-center "><!--Esto es una fila de la página aú no continene nada -->
					<div class="col-8 ">
						<form action="AsignarHorarioAc" method="post" class="">
							<div class="form-group row" >
								...
								<select name="materia" class="col-8 form-control custom-select">
                                                                    <%
                                                                        ...
                                                                        PreparedStatement ps=con.prepareStatement("select idmaterias,nombre from materias");
							...
							<div class="form-group row" >
								...
								<select name="profesor" class="col-8 form-control custom-select">
                                                                    ...
                                                                    rs=ps.executeQuery();
                                                                    while(rs.next()){
                                                                        out.println("<option  selected value='"+rs.getString("rfc")+"'>"+rs.getString("nombre")+" "+rs.getString("paterno")+" "+rs.getString("materno")+"</option>");
                                                                    }
                                                                    %>
								</select>
							</div>
							<div class="form-group row" >
								...
								<select name="grupo" class="col-8 form-control custom-select">
                                                                    ...
                                                                    rs=ps.executeQuery();
                                                                    while(rs.next()){
                                                                        out.println("<option  selected value="+rs.getString("idgrupo")+">"+rs.getString("nombre")+"</option>");
                                                                    }
                                                                    %>
								</select>
							</div>
