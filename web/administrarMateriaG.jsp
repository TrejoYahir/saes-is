    ...
    <body>
        <%
            ...
            if (request.getParameter("keyword") != null) {
                ...
                select = " WHERE Nombre LIKE '%" + keyword + "%'";
            }
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main col">
                    <div class="p-3">
                        <h3 class="pb-3">Administrar materias</h3>
                        <form action="administrarMateriaG.jsp" method="get">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><%=nivel%></td>
                                <td><%=creditos%></td>
                                <th class="text-center"><a class="btn btn-primary" href="./editarMateriaG.jsp?id=<%=id%>">Editar</a></th>
                            </tr>
                            <%
                                }
                            %>                                        
