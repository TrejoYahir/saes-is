    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main col">
                    <div class="p-3">
                        <h3 class="pb-3">Administrar alumno</h3>
                        <form action="administrarAlumnoG.jsp" method="get">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><%=correo%></td>
                                <td><%=estado%></td>
                                <th class="text-center"><a class="btn btn-primary" href="./editarAlumnoG.jsp?id=<%=id%>">Editar</a></th>
                            </tr>
                            <%
                                }
                            %>                                        
