        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main col align-items-center justify-content-center main">
                    ...
                    <form class="p-3" style="max-width: 400px;" action="EditarAlumnoG" method="post">
                        ...
                        <a href="administrarAlumnoG.jsp"><button type="button" class="btn btn-primary">Regresar</button></a>
                    </form>
                    <%
                        }else{
                     %>
