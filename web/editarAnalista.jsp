...
<html lang="es">
    ...
    <body>
        ...
        <%
            ...
            String select = " WHERE RFC = '" + id + "' and gestion.usuario_idusuario=usuario.idusuario";
            ...
            <div class="row">
                ...
                <main class="main col align-items-center justify-content-center main">
                    <%
                        ...
                        try {
                            String sql = "SELECT * FROM usuario,gestion" + select;
                    ...
                    %>
                    <div class="p-3">
                        <h3 class="pb-3">Editar Analista</h3>
                    ...
                    <form class="p-3" style="max-width: 400px;" action="EditarAnalista" method="post">
                        ...
                        <a href="administrarAnalista.jsp"><button type="button" class="btn btn-primary">Regresar</button></a>
                    </form>
                    <%
                        }else{
                     %>
