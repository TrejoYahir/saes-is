    ...
    <body>
        <%
            ...
            if (request.getParameter("keyword") != null) {
                ...
                select = " WHERE RFC LIKE '%" + keyword + "%' and academico.usuario_idusuario=usuario.idusuario";
            }else{
                select = " WHERE academico.usuario_idusuario=usuario.idusuario";
            }
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main col">
                    <div class="p-3">
                        <h3 class="pb-3">Administrar académico</h3>
                        <form action="administrarAcademicoG.jsp" method="get">
                        ...
                        <%
                            ...
                            try {
                                String sql = "SELECT * FROM academico,usuario" + select;
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><%=apellidom%></td>
                                <td><%=correo%></td>
                                <th class="text-center"><a class="btn btn-primary" href="./editarAcademicoG.jsp?id=<%=id%>">Editar</a></th>
                            </tr>
                            <%
                                }
                            %>                                        
